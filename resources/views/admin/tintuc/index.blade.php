...
<div class="container-fluid">
  ...
  <div class="card mb-3">
    <div class="card-header">
      ...
      <a href="{{route('tintuc.create')}}"><button type="button" class="btn btn-primary">Thêm tin</button></a>
      <div class="float-right">
        <form class="form-inline my-2 my-lg-0 mr-lg-2" method="GET" action="{{route('tintuc.search')}}">
           @csrf
